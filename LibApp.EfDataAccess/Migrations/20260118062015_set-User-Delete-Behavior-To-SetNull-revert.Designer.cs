...
namespace LibApp.EfDataAccess.Migrations
{
    ...
    [Migration("20260118062015_set-User-Delete-Behavior-To-SetNull-revert")]
    partial class setUserDeleteBehaviorToSetNullrevert
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("LibApp.Domain.Models.Author", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("LibApp.Domain.Models.Book", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("LibApp.Domain.Models.BookReservation", b =>
                {
                    ...
                    b.ToTable("BookReservations", "lib");
                });

            modelBuilder.Entity("LibApp.Domain.Models.Category", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("LibApp.Domain.Models.Department", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("LibApp.Domain.Models.Language", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("LibApp.Domain.Models.Publisher", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("LibApp.Domain.Models.Reservation", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("LibApp.Domain.Models.Role", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("LibApp.Domain.Models.User", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            City = "Belgrade",
                            ConcurrencyStamp = "45784e6f-fe5b-48e2-ae1b-3b5a6b253cbc",
                            CreatedByUserId = 1,
                            CreatedDateTime = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                        ...
                        new
                        {
                            ...
                            City = "Belgrade",
                            ConcurrencyStamp = "4d569622-bf31-48a4-a40e-9f229bda4c3a",
                            CreatedByUserId = 1,
                            CreatedDateTime = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            DateOfBirth = new DateTime(1996, 2, 7, 0, 0, 0, 0, DateTimeKind.Unspecified),
                        ...
                        new
                        {
                            ...
                            City = "Belgrade",
                            ConcurrencyStamp = "8859de22-df20-4a95-9beb-0fec514b685f",
                            CreatedByUserId = 1,
                            CreatedDateTime = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            DateOfBirth = new DateTime(1996, 2, 7, 0, 0, 0, 0, DateTimeKind.Unspecified),
            ...
            modelBuilder.Entity("BookAuthor", b =>
                {
                    b.HasOne("LibApp.Domain.Models.Author", null)
                        .WithMany()
                        .HasForeignKey("AuthorId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("LibApp.Domain.Models.Book", null)
                        .WithMany()
            ...
            modelBuilder.Entity("LibApp.Domain.Models.Book", b =>
                {
                    b.HasOne("LibApp.Domain.Models.Category", "Category")
                        .WithMany("Books")
                    ...
                    b.HasOne("LibApp.Domain.Models.Language", "Language")
                        .WithMany("Books")
            ...
            modelBuilder.Entity("LibApp.Domain.Models.BookReservation", b =>
                {
                    b.HasOne("LibApp.Domain.Models.Book", "Book")
                        .WithMany("BookReservations")
                        .HasForeignKey("BookId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("LibApp.Domain.Models.Reservation", "Reservation")
                        .WithMany("BookReservations")
            ...
            modelBuilder.Entity("LibApp.Domain.Models.User", b =>
                {
                    ...
                    b.HasOne("LibApp.Domain.Models.Role", "Role")
                        .WithMany("Users")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRoleClaim<int>", b =>
                {
                    b.HasOne("LibApp.Domain.Models.Role", null)
                        .WithMany()
                        .HasForeignKey("RoleId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<int>", b =>
                {
                    b.HasOne("LibApp.Domain.Models.User", null)
                        .WithMany()
